...
<form action='?register' method='post' enctype='multipart/form-data'>
    <fieldset>
        ...
        <input type='text' size='20' name='RegisterView::UserName' id='RegisterView::UserName' value='<?php echo $this->username; ?>'/>
        <br/>
        ...
        <br/>
        <input type="hidden" name="RegisterView::CsrfToken" value="<?php echo $this->csrfToken; ?>"/>
